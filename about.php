...
<body>
  ...
  <h1 class="font-bold text-7xl text-center pt-36">About Us</h1>
  </section>
  <section>
  ...
  <section class="bg-#1e293b py-16">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="text-6xl text-center font-extrabold text-yellow-500">
        Our Vision
      </h2>
      <div class="text-center mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <div>
    ...
    <div class="py-4 bg-white">
      <div class="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
        <div class="text-center">
          <p class="mt-8 text-3xl leading-7 text-gray-500 font-regular">
            F.A.Q
          </p>
          <h3 class="text-6xl leading-normal font-extrabold tracking-tight text-gray-900">
          ...
          <ul class="">
            <li class="text-left mb-10">
              <div class="flex flex-row items-start mb-5">
                <div class="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-yellow-500 text-white border-4 border-white text-xl font-semibold">
              ...
              <div class="flex flex-row items-start">
                ...
                <div class="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-yellow-500 text-white border-4 border-white text-xl font-semibold">
                  <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style="enable-background: new 0 0 295.238 295.238" xml:space="preserve">
                    <g>
                      <g>
                        <g>
